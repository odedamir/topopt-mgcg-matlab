...
% minVre(200,100,3,2,2,136.1,'trial')
function minVre(nelx,nely,penal,rmin,ft,compconst,filename)
%% MATERIAL PROPERTIES
E0 = 1;
Emin = 1e-9;
nu = 0.3;
